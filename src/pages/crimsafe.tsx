...
const CrimsafePage = () => {
  return (
    <main className="bg-white text-stylegroup-navy">
      {/* Hero Section */}
      ...
      <section className="bg-stylegroup-lightgray py-12">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { title: 'Strength', description: 'Crimsafe has been tested to be FIVE TIMES stronger than the Australian Standard.' },
              { title: 'Fastening Method', description: '‘Screw-Clamped’ Mesh – creates a barrier that cannot be kicked in.' },
              { title: 'Warranty', description: '12 Years of protection covered under your Crimsafe extended warranty.' },
              { title: 'Clamping System', description: 'Exclusive Screw-Clamp™ technology ensures a barrier that cannot be kicked in.' },
              { title: 'Locking Options', description: 'Can be mechanical or electronic (allowing access by Keypad, Bluetooth or Keyfob)' },
              { title: 'Stainless Mesh', description: 'Crimsafe Tensile-Tuff® stainless steel mesh is 26.5% thicker than typical stainless steel mesh.' },
            ].map((feature, index) => (
              <div key={index} className="bg-white p-6 rounded shadow hover:shadow-lg transition-shadow">
